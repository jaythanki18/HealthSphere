...
class _PharmacistRegisterState extends State<PharmacistRegister> {
                  ...
                  children: [
                    ...
                    RoundButton(
                      ...
                      onTap: () async {
                        ...
                        // PharmacistRegisterModel data = await PharmacistRegisterAPI().register(nameController.text, mobileController.text, emailController.text, "0", passwordController.text,_selectedImage.toString());
                        // if (formKey.currentState!.validate() && data.message != null && data.message == "Pharmacist registered successfully") {
                        //   var snackBar = SnackBar(
  ...
  // Future<void> createPharmacist() async {
  //   final String apiUrl = "http://192.168.192.8:3000/pharmacist";
